function AbsCalib=sedm_abswavecalib(varargin)
%--------------------------------------------------------------------------
% sedm_abswavecalib function                                          SEDM
...
DefV.LowerK          = [ 0.997.*239./240 -0.001 ];
DefV.UpperK          = [ 1.003.*239./240 +0.001 ];
DefV.GuessK          = [ 239./240 0 ];
DefV.VecK1           = [1100:1:1300].';
