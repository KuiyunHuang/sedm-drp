...
switch lower(InPar.IsListFF)
    ...
    case 'n'
        ...
        % select dome flats
        FlagDomeFF = (isempty_cell(strfind({KeywordS.NAME},InPar.HeadKeysVal{2}))==0) & ...
                     (isempty_cell(strfind({KeywordS.OBJECT},InPar.HeadKeysVal{1}))==0) & ...
